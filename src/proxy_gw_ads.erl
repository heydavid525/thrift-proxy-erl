...
make_request(AdType) ->
  ...
  gen_thrift_proxy:make_request_call(?SERVER_NAME, AdType, requestAds),
  gen_thrift_proxy:make_request_call(?SERVER_NAME, AdType, recordEvent),
  ok.
